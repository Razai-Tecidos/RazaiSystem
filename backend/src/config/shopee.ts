...
// Configurações do Shopee Open Platform
...
/**
 * Gera a assinatura HMAC-SHA256 para autenticação na API Shopee
 * 
 * Para APIs Públicas: partner_id + api_path + timestamp
...
/**
 * Gera URL de autorização completa para Shopee
 */
...
/**
 * Gera URL para cancelar autorização
 */
